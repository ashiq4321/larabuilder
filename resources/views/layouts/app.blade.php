            ...
            <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="{{ url('dashboard') }}">
                            <img alt="Logo"
                                src="{{ Auth::user()->company_id != '' ? get_company_logo() : get_logo() }}"
                        ...
                        @if (Auth::user()->user_type != 'admin')
                            ...
                            <div id="notificationsmenu" class="kt-header__topbar-item dropdown">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px"
                                    ...
                                    <span class="@if (Auth::user()->unreadNotifications->count() >
                                        0) kt-hidden @endif kt-badge
                                        kt-badge--danger">{{ Auth::user()->unreadNotifications->count() }}</span>
                                </div>
                                <div
                                                ...
                                                @foreach (Auth::user()->notifications->take(15) as $notification)
                                                    <a href="{{ url('notification/' . $notification->id) }}"
                                                        ...
                                                        <div class="kt-notification__item-icon">
                                                            <img
                                                                src="{{ asset('uploads/profile/' . $notification->user->profile_picture) }}">
                                                        </div>
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                    <span class="kt-header__topbar-icon kt-header__topbar-icon--info">
                                        <img class=""
                                            src="./../../uploads/flags/{{ session('language') == '' ? (Auth::user()->language == '' ? get_option('language') : Auth::user()->language) : session('language') }}.png"
                                            alt="" />
                                    </span>
                                </div>
                                            ...
                                            <li class="kt-nav__item">
                                                <a href="{{ url('?language=') }}{{ $language }}"
                                                    ...
                                                    <span class="kt-nav__link-icon"><img
                                                            src="./../../uploads/flags/{{ $language }}.png"
                                                            alt="" /></span>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--user">
                            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                                <div class="kt-header__topbar-user">
                                    ...
                                    @else
                                        <span
                                            class="kt-badge kt-badge--username kt-badge--unified-brand kt-badge--lg kt-badge--rounded kt-font-light kt-badge--bold">{{ Auth::user()->name }}</span>
                                    @endif
                                </div>
                            </div>
                            <div
                                ...
                                <div class="kt-notification">
                                    @if (Auth::user()->user_type == 'user' && get_option('membership_system') == 'enabled')
                                        ...
                                        <a href="{{ url('membership/my_subscription') }}"
                                            class="kt-notification__item">
                                            <div class="kt-notification__item-icon">
                    ...
                    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                        <div class="kt-container  kt-container--fluid  ">
                            <div class="kt-subheader__main">
                                @if (isset($page))
                                    <h3 class="kt-subheader__title"><button
                                            class="kt-subheader__mobile-toggle kt-subheader__mobile-toggle--left"
                                            id="kt_subheader_mobile_toggle"><span></span></button>{{ $page['title'] }}
                                    </h3>
                                ...
                                <div class="kt-subheader__breadcrumbs">
                                    ...
                                    @foreach (Request::segments() as $segment)
                                        ...
                                        @if ($loop->last)
                                            <span
                                                class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">{{ ucwords(str_replace('_', ' ', $segment)) }}</span>
                                        @else
                        ...
                        @if (has_membership_system() == 'enabled' && $user->user_type == 'user')
                            ...
                            @if ($user->company->membership_type == 'trial' && membership_validity() > date('Y-m-d'))
                                <div class="alert alert-warning" role="alert">
                                    <b>{{ _lang('You Are Currenly Using Trial Account !') }}&emsp;<a
                                            href="{{ url('membership/extend') }}"
                                            class="btn btn-danger btn-xs">{{ _lang('Upgrade Now') }}</a></b>
                                    <div class="clearfix"></div>
                                </div>
                            @endif
